...
* Derivaciones Cardiacas:
   ...
   * Derivaciones de extremidades:
     Son el registro de la diferencia de potenciales eléctricos entre dos puntos, ya sea entre dos electrodos (bipolar) o entre un punto virtual y un electrodo (monopolares). Como su nombre indica estas son tomadas en las extremidades, siendo RA (right arm), LA (left arm), RL (right leg) y LL (left leg). <p align="center"><img src="/ISB/Images/ecg/extremidades.PNG" width="600" ></p>
